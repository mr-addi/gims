...
if (isset($_POST['sumbit'])) {
    ...
    header("location: date_sheet_edit2.php?term=$term&session=$session&select=$select&section=$section");
}
?>
<!DOCTYPE html>
<html>
 ...
 <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <nav class="navbar navbar-inverse">
        ...
        <h2 class="text-center">Date Sheet<br> <sub><sub>(Edit Date-Sheet)</sub></sub> </h2>
        </div>
        ...
        <div class="col-md-10">
          <form action="" method="post">
            <table class="table table-bordered">
                ...
                <tr>
                  <td colspan="2"><input type="submit" name="sumbit" value=" NEXT > > " class="btn btn-success form-control"></td>
                </tr>
            </table>
          </form>
        </div>
