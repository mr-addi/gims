  ...
  <div class="container">
    ...
    <form class="" action="" method="post">
      <table class="table table-bordered">
        <!-- Header -->
        <tr>
          <th colspan="2" class="text-center bg-success text-white">Course Evaluation Report</th>
        </tr>
        <!--SESSION BLOCK  -->
        <tr>
...
(function() {
    $("#pdf_printin").click(function() {
      ...
      $.ajax({
        url: '../printing/course_evaluation_print.php',
        type: 'POST',
        data: {pdf_ses:pdf_ses_id,pdf_tea:pdf_tea_id,pdf_ses_tx:pdf_ses_text,pdf_tea_tx:pdf_tea_text,pdf_com:comments }
      })
      .done(function(data) {
