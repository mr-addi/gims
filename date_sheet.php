...
$sections=section_checker("Academics");
 if (array_search("Date Sheet",$sections)){ //check permission to this module
...
if (isset($_POST['sumbit'])) {
  ...
  foreach ($_POST['date_sheet'] as $key => $value) {
    ...
    $dt_sht_obj->insert_date_sheet($session,$class,$section,$term,$paper_code,$paper_title,$paper_type,$date,$time_from,$time_to,"insert");
  }
}
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#">Create Date-Sheet<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="datesheet/date_sheet_show.php">Print Date-Sheet</a></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="datesheet/date_sheet_edit.php" >Edit Date-Sheet</a>
                </li>
                </ul>
            <ul class="nav navbar-nav navbar-right">
               <li><a href="user_accounts/user_logout.php" class=" btn btn-default"><b> LOGOUT </b></a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>

        <h2 class="text-center">Date Sheet<br> <sub><sub>(Create New Date-Sheet)</sub></sub> </h2>
        </div>
  ...
  <div class="container">
    ...
    <div class="col-md-10">
      <form action="" method="post">
        ...
        <table class="table table-bordered" id="date_sheet_table">
  ...
  $("#class_select").change(function() {
    ...
    var chk_val=this.value;
      $.ajax({
        ...
        type:'POST',
        data: {param1 : chk_val,param2 : term_value}
      })
      .done(function(data) {
        $('#date_sheet_table').html(data);
      })
  });
  </script>
