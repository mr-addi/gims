...
if (isset($_POST['submit_deg'])) {
    ...
    $deg_obj=new degree();
    $deg_obj->insert_degree($deg_title,$deg_subj);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<nav class="navbar navbar-inverse">
      ...
      <h2 class="text-center">Degrees<br> <sub><sub>(Add new degrees)</sub></sub> </h2>
  </div>
          ...
          <form method="post" action="">
            <table class="table table-bordered">
                <tr>
                  ...
                  <td><input type="text" name="deg_title" class="form-control" required autofocus></td>
                </tr>
                <tr>
                  <th class="text-left">Degree Subject:</th>
                  <td><input type="text" name="deg_subject" class="form-control" required></td>
                </tr>
                <tr>
                  <td colspan="2">
                    <input type="submit" name="submit_deg" value="Submit" class="btn btn-success pull-right">
                    <a href="../degrees_page.php" class="btn btn-primary">CANCEL</a>
                  </td>
                </tr>
            </table>
          </form>
    ...
    <!-- <div class="footer_control">
      <small class="text-center">All Rights are Reserved by GIMS</small>
    </div> -->
